...
public class DebitoTest {
    ...
    public void setUp() throws Exception {
        ...
        tarjetaDebito = new Debito("1234567890123456", "Juan Perez", fecha);
    ...
    public void testRetirar() {
        try {
            ...
            tarjetaDebito.retirar(500.0);
            assertEquals(500.0, tarjetaDebito.getSaldo(), 0.001);
            verify(cuentaMock, times(1)).retirar(500.0);
        } catch (Exception e) {
