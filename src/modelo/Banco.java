...
public class Banco {
    ...
    public void abrirCuenta(String numeroCuenta, String titular) {
        cuentas.add(new Cuenta(numeroCuenta, titular));
    }
    ...
    public Debito crearTarjetaDebito(String numeroTarjeta, String titular, Date fechaCaducidad, String numeroCuenta) throws Exception {
        Cuenta cuenta = obtenerCuenta(numeroCuenta);
        if (cuenta == null) {
            throw new Exception("Cuenta no encontrada");
        }
        return new Debito(numeroTarjeta, titular, fechaCaducidad);
    }

    // Método para aprobar una operación (simula la aprobación de una operación bancaria)
